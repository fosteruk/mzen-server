...
class Server
{
  ...
  loadResources()
  {
    ...
    return Promise.resolve().then(function(){
      ...
      for (let accessorName in accessors) {
        ...
        var roleAssessor = new accessors[accessorName](null, this.modelManager.repos);
  ...
  registerRepoApiEndpoints()
  {
    ...
    for (var repoName in repos)
    {
      ...
      var repoAclConfig = apiConfig['acl'] ? apiConfig['acl'] : {};
      var disableEndpoints = apiConfig['disableEndpoints'] ? apiConfig['disableEndpoints'] : {};
      var disableEndpointGroups = apiConfig['disableEndpointGroups'] ? apiConfig['disableEndpointGroups'] : {};
      var endpoints = apiConfig['endpoints'] ? apiConfig['endpoints'] : {};
